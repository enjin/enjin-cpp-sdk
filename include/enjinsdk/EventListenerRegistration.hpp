...
public:
    ...
    public:
        ...
        /// \return This for chaining.
        RegistrationListenerConfiguration& with_allowed_events(std::vector<models::EventType> types);
        ...
        /// \return This for chaining.
        RegistrationListenerConfiguration& with_ignored_events(std::vector<models::EventType> types);
...
protected:
    ...
    /// \param listener The listener.
    /// \param matcher The matcher.
    EventListenerRegistration(std::shared_ptr<IEventListener> listener,
