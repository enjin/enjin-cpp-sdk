...
#ifndef ENJINCPPSDK_PLAYERSENDASSET_HPP
#define ENJINCPPSDK_PLAYERSENDASSET_HPP
...
TransactionFragmentArguments<player::SendAsset>::set_asset_id_format(models::AssetIdFormat asset_id_format);

template ENJINSDK_EXPORT player::SendAsset&
TransactionFragmentArguments<player::SendAsset>::set_with_blockchain_data();

template ENJINSDK_EXPORT player::SendAsset&
TransactionFragmentArguments<player::SendAsset>::set_with_meta();

template ENJINSDK_EXPORT player::SendAsset&
TransactionFragmentArguments<player::SendAsset>::set_with_encoded_data();

template ENJINSDK_EXPORT player::SendAsset&
TransactionFragmentArguments<player::SendAsset>::set_with_asset_data();

template ENJINSDK_EXPORT player::SendAsset&
TransactionFragmentArguments<player::SendAsset>::set_with_signed_txs();

template ENJINSDK_EXPORT player::SendAsset&
TransactionFragmentArguments<player::SendAsset>::set_with_error();

template ENJINSDK_EXPORT player::SendAsset&
TransactionFragmentArguments<player::SendAsset>::set_with_nonce();

template ENJINSDK_EXPORT player::SendAsset&
TransactionFragmentArguments<player::SendAsset>::set_with_state();

template ENJINSDK_EXPORT player::SendAsset&
TransactionFragmentArguments<player::SendAsset>::set_with_receipt();

template ENJINSDK_EXPORT player::SendAsset&
TransactionFragmentArguments<player::SendAsset>::set_with_receipt_logs();
...
#endif //ENJINCPPSDK_PLAYERSENDASSET_HPP
