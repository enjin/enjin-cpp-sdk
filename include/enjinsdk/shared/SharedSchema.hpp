...
public:
    ...
    std::future<graphql::GraphqlResponse<models::Request>> get_request(GetTransaction request) override;

    std::future<graphql::GraphqlResponse<std::vector<models::Request>>> get_requests(GetTransactions request) override;
