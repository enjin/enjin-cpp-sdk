...
BalanceFilter& BalanceFilter::set_project_uuid(std::string project_uuid) {
    BalanceFilter::project_uuid = std::move(project_uuid);
    return *this;
}

BalanceFilter& BalanceFilter::set_project_uuid_in(std::vector<std::string> project_uuids) {
    project_uuid_in = std::move(project_uuids);
    return *this;
}
