...
std::string GetBalances::serialize() {
    ...
    utils::join_serialized_objects_to_document(document, {
            BalanceFragmentArgumentsTemplate::serialize(),
...
bool GetBalances::operator==(const GetBalances& rhs) const {
    return static_cast<const graphql::AbstractGraphqlRequest&>(*this) ==
           ...
           static_cast<const BalanceFragmentArgumentsTemplate<GetBalances>&>(*this) ==
           static_cast<const BalanceFragmentArgumentsTemplate<GetBalances>&>(rhs) &&
           static_cast<const PaginationArgumentsTemplate<GetBalances>&>(*this) ==
           static_cast<const PaginationArgumentsTemplate<GetBalances>&>(rhs) &&
           filter == rhs.filter;
}
