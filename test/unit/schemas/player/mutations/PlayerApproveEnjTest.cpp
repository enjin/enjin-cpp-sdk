...
TEST_F(PlayerApproveEnjTest, SerializeNoSetFieldsReturnsEmptyJsonObject) {
    // Arrange
...
TEST_F(PlayerApproveEnjTest, SerializeSetFieldsReturnsExpectedJsonObject) {
    // Arrange
...
TEST_F(PlayerApproveEnjTest, EqualityNeitherSideIsPopulatedReturnsTrue) {
    // Arrange
    ApproveEnj lhs;
    ApproveEnj rhs;
...
TEST_F(PlayerApproveEnjTest, EqualityBothSidesArePopulatedReturnsTrue) {
    // Arrange
...
TEST_F(PlayerApproveEnjTest, EqualityLeftSideIsPopulatedReturnsFalse) {
    // Arrange
    ApproveEnj lhs = create_default_request();
    ApproveEnj rhs;
...
TEST_F(PlayerApproveEnjTest, EqualityRightSideIsPopulatedReturnsFalse) {
    // Arrange
    ApproveEnj lhs;
    ApproveEnj rhs = create_default_request();
