...
TEST_F(PlayerSendAssetTest, SerializeNoSetFieldsReturnsEmptyJsonObject) {
    // Arrange
...
TEST_F(PlayerSendAssetTest, SerializeSetFieldsReturnsExpectedJsonObject) {
    // Arrange
...
TEST_F(PlayerSendAssetTest, EqualityNeitherSideIsPopulatedReturnsTrue) {
    // Arrange
    SendAsset lhs;
    SendAsset rhs;
...
TEST_F(PlayerSendAssetTest, EqualityBothSidesArePopulatedReturnsTrue) {
    // Arrange
...
TEST_F(PlayerSendAssetTest, EqualityLeftSideIsPopulatedReturnsFalse) {
    // Arrange
    SendAsset lhs = create_default_request();
    SendAsset rhs;
...
TEST_F(PlayerSendAssetTest, EqualityRightSideIsPopulatedReturnsFalse) {
    // Arrange
    SendAsset lhs;
    SendAsset rhs = create_default_request();
