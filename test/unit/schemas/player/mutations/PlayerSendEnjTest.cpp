...
TEST_F(PlayerSendEnjTest, SerializeNoSetFieldsReturnsEmptyJsonObject) {
    // Arrange
...
TEST_F(PlayerSendEnjTest, SerializeSetFieldsReturnsExpectedJsonObject) {
    // Arrange
...
TEST_F(PlayerSendEnjTest, EqualityNeitherSideIsPopulatedReturnsTrue) {
    // Arrange
    SendEnj lhs;
    SendEnj rhs;
...
TEST_F(PlayerSendEnjTest, EqualityBothSidesArePopulatedReturnsTrue) {
    // Arrange
...
TEST_F(PlayerSendEnjTest, EqualityLeftSideIsPopulatedReturnsFalse) {
    // Arrange
    SendEnj lhs = create_default_request();
    SendEnj rhs;
...
TEST_F(PlayerSendEnjTest, EqualityRightSideIsPopulatedReturnsFalse) {
    // Arrange
    SendEnj lhs;
    SendEnj rhs = create_default_request();
