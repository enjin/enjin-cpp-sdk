...
class ProjectGetPlayersTest : public PlayerFragmentArgumentsTestSuite<GetPlayers>,
...
TEST_F(ProjectGetPlayersTest, SerializeNoSetFieldsReturnsEmptyJsonObject) {
    // Arrange
...
TEST_F(ProjectGetPlayersTest, SerializeSetFieldsReturnsExpectedJsonObject) {
    // Arrange
...
TEST_F(ProjectGetPlayersTest, EqualityNeitherSideIsPopulatedReturnsTrue) {
    // Arrange
    GetPlayers lhs;
    GetPlayers rhs;
...
TEST_F(ProjectGetPlayersTest, EqualityBothSidesArePopulatedReturnsTrue) {
    // Arrange
...
TEST_F(ProjectGetPlayersTest, EqualityLeftSideIsPopulatedReturnsFalse) {
    // Arrange
    GetPlayers lhs = create_default_request();
    GetPlayers rhs;
...
TEST_F(ProjectGetPlayersTest, EqualityRightSideIsPopulatedReturnsFalse) {
    // Arrange
    GetPlayers lhs;
    GetPlayers rhs = create_default_request();
